...
# ---------------- CHART 9 ----------------
st.subheader("9. Observation Distance Distribution")
if "Distance" in filtered.columns:
    fig = px.histogram(
        filtered.dropna(subset=["Distance"]),
        x="Distance",
        nbins=25,
...
# ---------------- CHART 10 ----------------
st.subheader("10. Temperature by Habitat")
if "Temperature" in filtered.columns:
    fig = px.box(
        filtered.dropna(subset=["Temperature"]),
        x="Habitat",
...
# ---------------- CHART 11 ----------------
st.subheader("11. Humidity by Habitat")
if "Humidity" in filtered.columns:
    fig = px.box(
        filtered.dropna(subset=["Humidity"]),
        x="Habitat",
...
# ---------------- CHART 12 ----------------
st.subheader("12. Observation Distance by Habitat")
if "Distance" in filtered.columns:
    fig = px.box(
        filtered.dropna(subset=["Distance"]),
        x="Habitat",
...
# ---------------- CHART 13 ----------------
st.subheader("13. Temperature vs Humidity")
...
# ---------------- CHART 14 ----------------
st.subheader("14. Temperature vs Observation Distance")
if {"Temperature", "Distance"}.issubset(filtered.columns):
    plot_df = filtered[["Temperature", "Distance", "Habitat"]].dropna()
    fig = px.scatter(
        plot_df,
        x="Temperature",
        y="Distance",
        color="Habitat",
        title="Temperature vs Observation Distance",
        opacity=0.55
    )
    st.plotly_chart(fig, use_container_width=True)

# ---------------- CHART 15 ----------------
st.subheader("15. Humidity vs Observation Distance")
if {"Humidity", "Distance"}.issubset(filtered.columns):
    plot_df = filtered[["Humidity", "Distance", "Habitat"]].dropna()
    fig = px.scatter(
        plot_df,
        x="Humidity",
        y="Distance",
...
# ---------------- CHART 16 ----------------
st.subheader("16. Bird Observations by Year and Habitat")
if "Year" in filtered.columns:
    c = (
...
# ---------------- CHART 17 ----------------
st.subheader("17. Monthly Bird Observation Trend")
...
# ---------------- CHART 18 ----------------
st.subheader("18. Monthly Observations by Habitat")
if "Month" in filtered.columns:
    c = (
...
# ---------------- CHART 19 ----------------
st.subheader("19. Sky Conditions")
...
# ---------------- CHART 20 ----------------
st.subheader("20. Wind Conditions")
...
# ---------------- CHART 21 ----------------
st.subheader("21. Disturbance Level")
...
# ---------------- CHART 22 ----------------
st.subheader("22. Flyover Observations by Habitat")
...
# ---------------- CHART 23 ----------------
st.subheader("23. Top 10 Species by Habitat")
if "Common_Name" in filtered.columns:
...
# ---------------- CHART 24 ----------------
st.subheader("24. Correlation Heatmap")
